...
var (
	baseOutputFileTemplate        = template.Must(template.New("modelgen-base").Funcs(funcMap).Parse(baseOutputFile))
	setsTemplate                  = template.Must(template.New("modelgen-sets").Funcs(funcMap).Parse(sets))
	eqWhereTemplate               = template.Must(template.New("modelgen-eq-where").Funcs(funcMap).Parse(eqWhere))
	scalarWhereTemplate           = template.Must(template.New("modelgen-scalar-where").Funcs(funcMap).Parse(scalarWhere))
	limitOffsetTemplate           = template.Must(template.New("modelgen-limit-offset").Funcs(funcMap).Parse(limitOffset))
	queryBuilderTemplate          = template.Must(template.New("modelgen-query-builder").Funcs(funcMap).Parse(queryBuilder))
	selectQueryBuilderTemplate    = template.Must(template.New("modelgen-select-builder").Funcs(funcMap).Parse(selectQueryBuilder))
	updateQueryBuilderTemplate    = template.Must(template.New("modelgen-update-builder").Funcs(funcMap).Parse(updateQueryBuilder))
	deleteQueryBuilderTemplate    = template.Must(template.New("modelgen-delete-builder").Funcs(funcMap).Parse(deleteQueryBuilder))
	fromRowsTemplate              = template.Must(template.New("modelgen-from-rows").Funcs(funcMap).Parse(fromRows))
	toRowsTemplate                = template.Must(template.New("modelgen-to-rows").Funcs(funcMap).Parse(toRows))
	finishersTemplate             = template.Must(template.New("modelgen-finishers").Funcs(funcMap).Parse(finishers))
	placeholderGeneratorTemplate  = template.Must(template.New("modelgen-placeholder").Funcs(funcMap).Parse(placeholderGenerator))
	schemaTemplate                = template.Must(template.New("modelgen-schema").Funcs(funcMap).Parse(schema))
	queryBuilderInterfaceTemplate = template.Must(template.New("modelgen-interface").Funcs(funcMap).Parse(queryBuilderInterface))
	orderByTemplate               = template.Must(template.New("modelgen-orderby").Funcs(funcMap).Parse(orderBy))
)
...
{{ end }}
`
const baseOutputFile = `// Code generated by modelgen. DO NOT EDIT
package {{ .Pkg }}
